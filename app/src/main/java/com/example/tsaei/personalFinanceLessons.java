...
public class personalFinanceLessons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.personal_finance_lessons);
    ...
    public void get_json() {
        String json;
        try {
            InputStream is = getAssets().open("personalfinancedefinitions.json");
